...
{!! str_pad("Route::get('/admin/".$modelRouteAndViewName."/resend-activation/{".$modelRouteAndViewName."}',", 60) !!}'{{ $controllerPartiallyFullName }}@resendActivationEmail')->name('admin/{{ $modelRouteAndViewName }}/resendActivationEmail');